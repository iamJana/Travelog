  ...
  return SingleChildScrollView(
    child: Column(
      children: [
        ...
        Mountlist('images/himages/sathuragiri.jpg', 'Sathuragiri Hills',
            'otherwise known as Sundara Mahalingam', 16),
        Mountlist('images/himages/sirumalai.JPG', 'Sirumalai Hills',
            'dense forest region with moderate climate throughout the year', 17), 
        Mountlist('images/himages/topslip.JPG', 'Topslip Hills',
            'one of the hill stations near Chennai', 18),
        Mountlist('images/himages/valparai.jpg', 'Valparai Hills',
            'Anaimalai Hills range of the Western Ghats', 19), 
        Mountlist('images/himages/yelagiri.png', 'Yelagiri Hills',
            'The Vaniyambadi-Tirupattur road', 20), 
        Mountlist('images/himages/velliangiri.jpg', 'Velliangiri Hills',
            'Important destination in the Nilgiris', 21),                                          
      ],
    ),
  );
}
